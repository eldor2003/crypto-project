...
class Hands extends React.Component {
  ...
  componentDidMount() {
    ...
    ballEl && ballEl.addEventListener('mouseenter', () => {
      ballEl.style.transform = 'translate(0, 0) rotate(-30deg) scale(1.33)';
      leftArmEl.style.transform = 'translate(60px, -30px) rotate(3deg) scale(1.05)';
      rightArmEl.style.transform = 'translate(-190px, 20px) rotate(-2deg)';
    });
    
    ballEl && ballEl.addEventListener('mouseleave', () => {
